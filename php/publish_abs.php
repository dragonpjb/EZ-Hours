<?php session_start(); 
	...
	$abs= $_POST['abstract']; //article Id number
	...
	if($isHere == 1)
	{
		...
		$sql = "UPDATE  articles SET abstract='".$abs."'WHERE article_id=".$article_id;
		echo $sql;
	}
	else
	{
		echo "The article is new.<br/>";
		$sql = "INSERT INTO articles (title, author, abstract) VALUES ('".$title."', '".$author_id."', '".$abs."')";
		echo $sql;
	}
