...
<body class="body_basic">
    ...
    <div id="search_bar">
        ...
        <div id="arts" class="test">
			<h3 class="test">More Articles</h3>
			<ul class="test">
				
				<li><a href="reader.php?article_id=17">Women and heart disease,</a></li>
				<li><a href="reader.php?article_id=16">Caring For Family Caregivers Of Older Persons,</a></li>
				<li><a href="reader.php?article_id=15">Nursing care of the oldest-old</a></li>
